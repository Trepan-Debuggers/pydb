% $Id: libpydb.tex,v 1.46 2006/05/27 02:58:56 rockyb Exp $
...
\item[commands \optional{\optional{\var{pbnumber}}}]
...
followed by 'end'.  This is because any time you resume execution (even
...
\file{pydb.py} can also be invoked as a script to debug other scripts.
For example:
