% $Id: libpydb.tex,v 1.56 2006/07/13 02:14:57 rockyb Exp $
...
\code{pydb} \optional{\var{debugger-options}\ldots} \optional{\var{python-script} \optional{\var{script-options}\ldots}}
...
\begin{funcdesc}{set_trace}{\optional{cmdfile=None, add_exception_hook=True}}\label{set-trace}
...
The \code{cmdfile} allows you to run a debugger command file before
entering the debugger. Unless \code{add_exception_hook} is set to
