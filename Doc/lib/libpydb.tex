% $Id: libpydb.tex,v 1.49 2006/05/27 11:56:42 rockyb Exp $
...
places. For this, the \code{pydb} function \code{set_trace()} can be
used. I've even this method to debug the debugger itself and to debug
regression tests.
...
\begin{funcdesc}{set_trace}{\optional{cmdfile=None}}
