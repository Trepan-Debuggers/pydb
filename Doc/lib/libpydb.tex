% $Id: libpydb.tex,v 1.66 2006/07/28 00:47:46 rockyb Exp $
...
You can run debugger commands by passing this as a list to
\code{set_trace}.  Unless \code{add_exception_hook} is set to
