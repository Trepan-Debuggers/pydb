% $Id: libpydb.tex,v 1.27 2006/02/27 16:20:46 rockyb Exp $
...
myscript.py} you are running \code{pydb} first which then invokes
your script \code{myscript.py}. \code{pydb} tries hard to make itself
transparent and thus strips its own program options, resets
