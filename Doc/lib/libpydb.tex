% $Id: libpydb.tex,v 1.137 2008/12/25 22:53:25 rockyb Exp $
...
If there's somethone you want to run before stepping you can do that
...
\begin{verbatim}
    ...
    sys.settrace(_pydb_trace.trace_dispatch)
\end{verbatim}
