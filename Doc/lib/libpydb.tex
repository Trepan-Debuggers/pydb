% $Id: libpydb.tex,v 1.48 2006/05/27 11:50:20 rockyb Exp $
...
\module{readline} or \module{pyreadline}. The parameter name here is
...
\ulink{\module{\code
cmd.py}}{http://docs.python.org/lib/module-cmd.html} and \module{bdb}
