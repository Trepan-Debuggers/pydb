% $Id: libpydb.tex,v 1.74 2006/09/16 19:07:40 rockyb Exp $
...
There are in fact three possibilities. The first way requires
modification to your program but does require that the program was run
from the Python interpreter shell. The second possibility doesn't
require being in the Python interpreter shell, but does require
