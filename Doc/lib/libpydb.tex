% $Id: libpydb.tex,v 1.102 2006/12/10 13:26:23 rockyb Exp $
...
\code{None} means the default set. If you want \em{no} signals, use [].
\end{classdesc}
...
parameter \code{siglist} gives a list of signals to intercept and ignore.
\end{classdesc}
