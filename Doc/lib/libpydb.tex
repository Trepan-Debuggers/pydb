% $Id: libpydb.tex,v 1.132 2008/05/17 10:08:33 rockyb Exp $
...
cumbersome. However should you want to change this, you can seet
this off.
...
seems to be an artifact of how the interpeter is written to speed up
name lookup for access to local variables. As a result, the locals
...
supplied, it is splitted with \code{shlex} but preserving embedded
...
\begin{description}
\item[info thread \optional{\var{thread-name}{\Large{|}}\var{thread-number}}
...
\begin{description}
\item[frame \optional{\var{thread-Name}{\Large{|}}\var{thread-number}} \var{frame-number}]
...
debugger state to be used, set parameter new_instance \code{True}.
\end{funcdesc}
