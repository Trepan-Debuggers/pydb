% $Id: libpydb.tex,v 1.115 2007/04/11 09:28:50 rockyb Exp $
...
\begin{verbatim}
$ pydb --basename --fntrace gcd.py 4 6
--Call level 3--
(gcd.py:13):  check_args
+  13 def check_args():
--Return from level 3 (<type 'NoneType'>)--
--Call level 3--
(gcd.py:24):  gcd
+  24 def gcd(a,b):
--Call level 4--
...
(gcd.py:24):  gcd
+  24 def gcd(a,b):
--Return from level 5: 2--
--Return from level 4: 2--
--Return from level 3: 2--
The GCD of 4 and 6 is 2
--Return from level 2 (<type 'NoneType'>)--
...
(hanoi.py:9):  hanoi
+  9     if n-1 > 0:
--Return from level 4 (<type 'NoneType'>)--
(hanoi.py:9):  hanoi
+  9     if n-1 > 0:
(hanoi.py:8):  hanoi
+  8     print "Move disk %s to %s" % (a, b)
