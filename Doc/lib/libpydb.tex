% $Id: libpydb.tex,v 1.32 2006/03/13 22:23:29 rockyb Exp $
...
If a readline module is available, \code{pydb} can keep track of the
commands you type during your debugging sessions, so that you can be
certain of precisely what happened.  The \code{set history} commands
